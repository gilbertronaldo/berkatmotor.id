                                ...
                                <ul>
                                    ...
                                    <li class="sub-menu"><a class="sub-menu-title" href="#">blog grid view</a>
                                        <ul>
                                            ...
                                            <li><a href="blog-full-width-left-sidebar.html">full width left sidebar</a>
                                            </li>
                                            <li><a href="blog-full-width-right-sidebar.html">full width right
                                                    sidebar</a></li>
                                            <li><a href="blog-full-width-nosidebar.html">full width no sidebar</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="sub-menu"><a class="sub-menu-title" href="#">blog List Creative</a>
                                        <ul>
                                    ...
                                    <li class="sub-menu"><a class="sub-menu-title" href="#">blog mix layout</a>
                                        <ul>
                                            <li><a href="blog-list-mix-left-sidebar.html">List mix with Left sidebar</a>
                                            </li>
                                    ...
                                    <li class="sub-menu"><a class="sub-menu-title" href="#">blog masonry</a>
                                        <ul>
                                            ...
                                            <li><a href="blog-list-full-width-no-sidebar.html">Grid list mix</a></li>
                                            <li><a href="blog-list-mix-no-sidebar.html">Grid list creative mix</a></li>
                                        </ul>
                                    </li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="menu-container">
                                                    <ul class="menu-icon">
                                                        <li><a href="alert.html"><i class="icon-alert"></i>alerts</a>
                                                        </li>
                                                        <li><a href="accordion.html"><i
                                                                    class="icon-layout-accordion-merged"></i>accordion</a>
                                                        </li>
                                                        <li><a href="boxshadow.html"><i class="icon-layers"></i>box
                                                                shadow</a></li>
                                                        <li><a href="button.html"><i class="icon-write"></i>buttons</a>
                                                        </li>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="menu-container">
                                                    <ul class="menu-icon">
                                                        <li><a href="event-schedule.html"><i class="icon-list"></i>event-schedule</a>
                                                        </li>
                                                        <li><a href="gallery.html"><i
                                                                    class="icon-gallery"></i>gallery</a></li>
                                                        <li><a href="pricing.html"><i class="icon-money"></i>pricing</a>
                                                        </li>
                                                        <li><a href="counter.html"><i class="icon-time"></i>counter</a>
                                                        </li>
                                                        <li><a href="countdown.html"><i class="icon-alarm-clock"></i>countdown</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="menu-container">
                                                    <ul class="menu-icon">
                                                        <li><a href="progress.html"><i class="icon-bar-chart"></i>progress
                                                                bar</a></li>
                                                        <li><a href="testimonial.html"><i class="icon-thought"></i>testimonial</a>
                                                        </li>
                                                        <li><a href="video.html"><i class="icon-video-camera"></i>video</a>
                                                        </li>
                                                        <li><a href="services.html"><i class="icon-headphone"></i>service</a>
                                                        </li>
                                                        <li><a href="subscribe.html"><i class="icon-share-alt"></i>subscribe</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="menu-container">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="portfolio-title-3-col.html">3 column with title</a>
                                                        </li>
                                                        <li><a href="portfolio-title-4-col.html">4 column with title</a>
                                                        </li>
                                                        <li><a href="portfolio-parallex.html">With parallex effect</a>
                                                        </li>
                                                        <li><a href="portfolio-centered-slides.html">centered slides</a>
                                                        </li>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="menu-container">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="portfolio-detail.html">Details with slider</a></li>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="menu-container">
                                                    <a class="menu-head" data-target=".demo2" data-toggle="collapse"
                                                       href="#">Trending Layouts</a>
                                                    <ul>
                                                        <li><a href="portfolio-creative-1.html">Trending Layout 1</a>
                                                        </li>
                                                        <li><a href="portfolio-creative-2.html">Trending Layout 2</a>
                                                        </li>
                                                        <li><a href="portfolio-creative-3.html">Trending Layout 3</a>
                                                        </li>
                                                        <li><a href="portfolio-creative-4.html">Trending Layout 4</a>
                                                        </li>
                                                        <li><a href="portfolio-modern-4-col.html">Trending Layout 5</a>
                                                        </li>
                                                        <li><a href="portfolio-modern-3-col.html">Trending Layout 6</a>
                                                        </li>
                                                        <li><a href="portfolio-modern-2-col.html">Trending Layout 7</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="menu-container">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="category-page-rightsidebar(4-grid).html">right
                                                                sidebar <i class="fa fa-magic color-animated"></i></a>
                                                        </li>
                                                        <li><a href="category-page-rightsidebar(2-grid).html">right 2
                                                                grid</a></li>
                                                        <li><a href="category-page-rightsidebar(3-grid).html">right 3
                                                                grid</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col menu-container">
                                                ...
                                                <ul>
                                                    <li><a href="category-page-rightsidebar(6-grid).html">right 6
                                                            grid</a></li>
                                                    <li><a href="category-page-nosidebar(4-grid).html">no sidebar</a>
                                                    </li>
                                            ...
                                            <div class="col menu-container">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="product-page(3-column).html">3 grid<i
                                                                class="fa fa-thumbs-o-up color-animated"></i></a></li>
                                                    <li><a href="product-page(3-col-left).html">3 grid-left </a></li>
                                                    <li><a href="product-page(3-col-right).html">3 grid-right</a></li>
                                                </ul>
                                            </div>
                                            <div class="col menu-container">
                                                <a class="menu-head" data-target=".demo2" data-toggle="collapse"
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="product-page(bundle).html">bundle<i
                                                                class="fa fa-chain-broken color-animated"></i></a></li>
                                                ...
                                                <div class="menu-container">
                                                    ...
                                                    <ul>
                                                        <li><a href="cart.html">cart <i
                                                                    class="fa fa-cart-plus color-animated"></i></a></li>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="menu-container">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="footer1-dark.html">footer dark gradient </a></li>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="menu-container">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="popup-with-youtube.html">youtube in popup</a></li>
